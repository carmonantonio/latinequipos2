...
<div class="container">
  ...
  <div class="c-layout-sidebar-content "> 
    ...
    <?php } ?>
    <div class="c-shop-result-filter-1 clearfix form-inline" style="margin-bottom:2%">
            <div class="c-filter">
          ...
          <?php if(!empty($ads_row)){$cat_id = $ads_row->category_id; }else{$cat_id = "";} ?>
    ...
    <div class="c-content-box c-size-md c-overflow-hide c-bs-grid-small-space c-bg-grey-1">
                        ...
                        <div class="col-md-4 col-sm-6 c-margin-b-20">
                            <div class="c-content-product-2 c-bg-white" style="min-height:350px;max-height:350px;">
                                <div class="c-content-overlay">
                                    ...
                                    <?php 
				  $picture = json_decode($ads->pictures);
					if(!empty($picture)){
					foreach($picture as $picture){ ?>
                  <img src="<?php echo base_url("assets/web/uploads/products/".$picture); ?>" class="c-bg-img-center c-overlay-object" data-height="height" style="height:275px;width:275px;"  />
                    ...
                    <?php } ?>
                                ...
                                <div class="c-info">
                                <?php
					  if($ads->selling_price=="0"){
						$price = "Price On Request";
					  }else{
						$price = $ads->selling_price;
					  }
				  ?>
                  <p class="c-title c-font-11 c-font-slim"><?php //echo substr($ads->name, 0, 15).'....'.' <b>'.$price; ?>
                  <?php
                  	echo "<strong>".substr($ads->name, 0, 35)."</strong><br>";
					echo $ads->category_name."<br>";
					echo $price;
				  ?>
                  </p>
                                </div>
                        ...
                        <em><?php echo $this->lang->line("norecordefound");?></em>
                        </div>
...
function filter_search(val){
	...
	$.post("<?php echo site_url("home/filter_search"); ?>",{val:val,cat_id:cat_id}).done(function(data){
		$("#load_more").html(data);
		/*$("#load_btn").fadeOut();*/
	});
}
