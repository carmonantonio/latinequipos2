                                ...
                                <div class="c-content-overlay">
                                    <div class="c-overlay-wrapper">
                                        <div class="c-overlay-content">
                                            <a href="<?php echo site_url("home/search_ad/".$product->id); ?>" class="btn btn-md c-btn-grey-1 c-btn-uppercase c-btn-bold c-btn-border-1x c-btn-square">Explore</a>
                                        </div>
                                    </div>
                  ...
                  <img src="<?php echo base_url("assets/web/uploads/products/".$picture); ?>" class="c-bg-img-center c-overlay-object" data-height="height" style="height: 275px;width:275px;"  />
                    ...
                    <?php } ?>
                                ...
                                <?php if($product->selling_price=="0"){ $price = "Price On Request"; }else{ $price = $product->selling_price ?>
                                    ...
                                    <p class="c-title c-font-12 c-font-slim" style="font-size:14px;">
									<?php //echo $product->category_name." - ".$product->model." - ".$product->year." - ".$price; 
