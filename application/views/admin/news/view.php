        ...
        <table class="table table-striped table-bordered table-hover" id="sample_1">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td width="5"><a href="<?php echo site_url("admin/news/getnews/".$news->id); ?>" class="btn btn-fit-height green dropdown-toggle">Edit</a><a href="<?php echo site_url("admin/news/delete/".$news->id); ?>" class="btn btn-fit-height red dropdown-toggle">Delete</a></td>
            </tr>
            <?php }} ?>
          </tbody>
        </table>
