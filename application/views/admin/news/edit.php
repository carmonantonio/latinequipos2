...
<div class="row">
  <div class="col-md-12"> 
    ...
    <div class="portlet light portlet-fit portlet-form ">
      ...
      <!-- BEGIN FORM-->
      <form action="<?php echo site_url("admin/news/update/".$news_en->id); ?>" id="form_sample_1" class="form-horizontal" method="post" enctype="multipart/form-data">
        <div class="form-body">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">
              <input type="text" name="title_en" data-required="1" class="form-control" required="required" value="<?php echo $news_en->title; ?>" />
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-3">Description <span class="required"> * </span> </label>
            <div class="col-md-6">
              <textarea  name="description_en" data-required="1" class="form-control" required="required" ><?php echo $news_en->description; ?></textarea>
            </div>
          </div>
		  </div>
		  <div class="col-md-6">
          <div class="form-group">
            ...
            <div class="col-md-6">
              <input type="text" name="title_es" data-required="1" class="form-control" required="required" value="<?php  echo $news_es->title; ?>" />
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-md-3">Descripción <span class="required"> * </span> </label>
            <div class="col-md-6">
              <textarea  name="description_es" data-required="1" class="form-control" required="required" ><?php echo $news_es->description; ?></textarea>
            </div>
          </div>
		  </div>
		  <div class="form-group">
            ...
            <div class="col-md-4">
              <input class="form-control form-control-inline input-medium date-picker" size="16" type="text" value="<?php  echo date("m/d/Y", strtotime($news_en->date)); ?>" name="date"  />
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-4">
            <img src="<?php echo base_url("assets/web/uploads/news/".$news_en->image); ?>" style="width:50%">
            </div>
          </div>
        </div>
