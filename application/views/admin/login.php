...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="<?php echo site_url(); ?>assets/web/base/img/layout/logos/logo-1.png" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="<?php echo site_url("admin/auth/authentication"); ?>" method="post">
        ...
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright"> 2014 &copy; Latinequips - Admin Panel. </div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
